...
#page[
  ...
  #v(0.15em)
  #callout(kind: "info")[
    *勝利獎勵*：勝方保留自身兵力 + $floor("（所有敗方兵力加總）" times 20%)$；聯合進攻中每位成員*各自獨立*獲得此獎勵。*敗方*兵力全數損失。
  ]
  ...
  #example-box("一", "移動與進攻")[
    ...
    *結算結果*
    #table(
      ...
      stroke: 0.5pt + rgb("#BDBDBD"),
      fill: white,
      [1小隊], [椰島A：500 + $floor(250 times 20%)$ = *550 兵*；椰島C：200 兵移入（×1.5 = 300）],
  ...
  #example-box("二", "聯盟防守（union）")[
    ...
    *結算結果*
    #table(
      ...
      stroke: 0.5pt + rgb("#BDBDBD"),
      fill: white,
      [2小隊（領主）], [守住椰島B，獲 +80 獎勵兵（$floor(400 times 20%)$）],
  ...
  #example-box("三", "聯合進攻（union_attack）")[
    ...
    *結算結果*
    #table(
      ...
      fill: white,
      [隊伍], [身份], [結果],
      [1小隊], [新領主], [400 + $floor(500 times 20%)$ = 400 + 100 = *500 兵*，成為椰島E 領主],
      [2小隊], [駐守], [300 + $floor(500 times 20%)$ = 300 + 100 = *400 兵*，駐守椰島E],
